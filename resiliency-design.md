...
![A green and white logo on a black background Description automatically generated](image/Veeam-Replication-architecture.drawio.svg){: caption="Figure 1. Veeam standard replication architecture on IBM Cloud" caption-side="bottom"}
...
![A black background with white text Description automatically generated](image/Veeam-CDP-Architecture.svg){: caption="Figure 2 Veeam Continious Data Protection architecture on IBM Cloud" caption-side="bottom"}
